...
return [
    ...
    'events' => [
        ...
        'register_confirm' => '¿Te gustaría inscribirte en este evento?',
        'unregister_confirm' => '¿Te gustaría cancelar tu inscripción?',
        ...
        'comment_update_confirm' => '¿Te gustaría guardar tu comentario?',
        ...
        'join_waitlist' => 'Este evento está completo. ¿Te gustaría unirte a la lista de espera?',
        ...
        'export_col_gender' => 'Tratamiento',
        'export_col_is_guest' => 'Invitado',
        'export_col_timestamp' => 'Fecha de registro',
        'export_yes' => 'Sí',
        'export_no' => 'No',
        'description' => 'Descripción',
        'price_members' => 'Precio de Socios',
        'price_guests' => 'Precio de Invitados',
...
Tenga en cuenta que los socios del club tienen prioridad en la asignación de las plazas disponibles.',
    ...
    'social_events' => [
        ...
        'new' => 'Nuevo Evento Social',
        'create' => 'Crear Evento Social',
        'name' => 'Nombre',
        'date' => 'Fecha',
        'description' => 'Descripción',
        'registration_close' => 'Cierre de Inscripción',
        'menus' => 'Opciones de Menú',
        'menus_hint' => 'Lista separada por comas, p.ej. Carne, Pescado, Verduras',
        'tables' => 'Mesas',
        'tables_hint' => 'Número de asientos separados por comas, p.ej. 10, 10, 8, 8',
        'table' => 'Mesa',
        'table_number' => 'Mesa :number',
        'libero' => 'Sin preferencia',
        'menu' => 'Menú',
        'select_menu' => 'Seleccionar menú',
        'select_table' => 'Seleccionar mesa (opcional)',
        'register' => 'Inscribirse',
        'unregister' => 'Cancelar inscripción',
        'register_confirm' => '¿Te gustaría inscribirte en este evento social?',
        'unregister_confirm' => '¿Te gustaría cancelar tu inscripción al evento social?',
        'registered' => 'Inscrito',
        'not_found' => 'Evento social no encontrado',
        'event_full' => 'Este evento está completo.',
        'table_full' => 'Esta mesa está completa. Por favor elija otra mesa o sin preferencia.',
        'invalid_menu' => 'Selección de menú no válida.',
        'invalid_table' => 'Selección de mesa no válida.',
        'save' => 'Guardar',
        'delete' => 'Eliminar',
        'delete_confirm' => '¿Eliminar evento social permanentemente?',
        'lock' => 'Bloquear',
        'lock_confirm' => '¿Bloquear evento social?',
        'unlock' => 'Desbloquear',
        'unlock_confirm' => '¿Desbloquear evento social?',
        'locked_message' => 'Inscripción cerrada.',
        'edit' => 'Editar',
        'tournament' => 'Torneo',
        'linked_tournament' => 'Torneo Vinculado',
