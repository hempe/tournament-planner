...
A demo page is included at `examples/iframe-demo.html` that shows the application embedded in an iframe, matching the exact layout of the Golf El Faro website:
...
# Open in browser
http://localhost:5000/examples/iframe-demo.html
```
