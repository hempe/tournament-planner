        ...
        content: new Card(
            ...
            content: new Table(
                ...
                projection: fn($i) => match ($i) {
                    ...
                    1 => [__('guests.first_name'), '<input type="text" name="first_name" class="input" value="' . htmlspecialchars($guest->firstName) . '" placeholder="' . __('guests.first_name') . '" required>'],
                    2 => [__('guests.last_name'), '<input type="text" name="last_name" class="input" value="' . htmlspecialchars($guest->lastName) . '" placeholder="' . __('guests.last_name') . '" required>'],
                    3 => [__('guests.email'), '<input type="email" name="email" class="input" value="' . htmlspecialchars($guest->email) . '" placeholder="' . __('guests.email') . '" required>'],
                    4 => [__('guests.handicap'), '<input type="number" step="0.1" name="handicap" class="input" value="' . htmlspecialchars((string) $guest->handicap) . '" placeholder="' . __('guests.handicap') . '" required>'],
